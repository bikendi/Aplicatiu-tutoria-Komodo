...
function selparams() {
  ...
  if ((''!=document.introd1.grup.options[document.introd1.grup.selectedIndex].text)&&
      ...
      document.introd1.params.value = aux;
...
<table border='0'>
<tr><td><font size='6'>Resum avaluaci&oacute;&nbsp; &nbsp; </font></td>
...
<td><input type='hidden' name='params' value=''><input type='submit' value='Crear resum' onClick='selparams();'></td>
<td align='right'><b>Grup:</b> <select name='grup' onChange='if(ie) document.informe.window.location.href=\"buit.php?idsess=$idsess\"; if(ns6) document.getElementById(\"informe\").src=\"buit.php?idsess=$idsess\";'>
<option></option>");
do {
...
if ($params!='') $pagina="resumaval_pdf.php?idsess=$idsess".$params;
?>
